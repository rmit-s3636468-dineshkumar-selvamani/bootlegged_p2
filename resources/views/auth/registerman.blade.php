            ...
            @csrf
                    <input class="form_box form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" type="email" name="email" placeholder="Email" id="email" required ><br>
                      @if ($errors->has('email'))
                                ...
                                @endif
                    <input class="form_box form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" type="text" name="businessName" placeholder="Business Name" id="businessName" required><br>
                     @if ($errors->has('name'))
                                    <span class="invalid-feedback" role="alert">
                    ...
                    <input class="form_box" type="number" name="contact_no" placeholder="Contact Number" id="contact_no"required><br><br>
